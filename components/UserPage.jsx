  ...
  return (
    <div className={styles.userPage}>
        ...
        <div className={styles.infoContainer}>
          ...
          <div className={styles.userStats}>
            <div className={styles.userStat}>
              <h3 className={styles.statNumber}>{user.followers_count}</h3>
              <div className={styles.statName}>Followers</div>
            </div>
            <div className={styles.userStat}>
              <h3 className={styles.statNumber}>{user.following_count}</h3>
              <div className={styles.statName}>Following</div>
            </div>
            <div className={styles.userStat}>
              <h3 className={styles.statNumber}>{user.total_photos}</h3>
      ...
      <div className={styles.galleryViewSwitch}>
        <button onClick={handleViewToggle} className={styles.buttonSetView}>
      ...
      {/* gallery */}
      ...
      
        {
          ...
          <div className={styles.userGalleryListView}>
            {
            user.photos.map((photo) => (
            <Post user={user} location={user.location} likes={user.likes} downloads={user.downloads} image={photo.urls} key={photo.id} isLast={false} description={""}/>
          ))}
          </div>
        }
